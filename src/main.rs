...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/fetch-coin-market-cap-data/{coin_id}", get(handlers::historical::fetch_coin_market_cap_data))
        ...
        .route("/indexes/{index_id}/orderbook", get(handlers::orderbook::get_index_orderbook))
